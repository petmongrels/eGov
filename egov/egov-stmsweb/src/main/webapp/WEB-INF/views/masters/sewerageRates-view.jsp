					...
					<div class="panel panel-primary">
						...
						<div class="panel-body history-slide">
							...
							<div class="form-group col-sm-6 col-sm-offset-3">
								<table class="table table-bordered datatable nopointer" style="width:500%">
									<thead>
										<tr>
											<th ><label><spring:message
													code="lbl.slno" /></label></th>
											<th  style="width:30%"><label><spring:message
														code="lbl.propertytype" /></label></th>
											<th style="width:30%"><label><spring:message
														code="lbl.effective.fromdate" /></label></th>
											<th style="width:30%"><label><spring:message
														code="lbl.monthlyrate"></spring:message> </label></th>
											<th style="width:30%"><label><spring:message
														code="lbl.active"></spring:message> </label></th>
										</tr>
									</thead>
									<tbody id="tblBody">
										<c:forEach var="sewerageRatesMasterList"
											items="${sewerageRatesMasterList}" varStatus="index">
											<tr>
												<td><c:out value="${index.index + 1}" /></td>
												<td id="propertyType"><c:out
														value="${sewerageRatesMasterList.propertyType}" /></td>
												<td><fmt:formatDate pattern="dd/MM/yyyy"
														value="${sewerageRatesMasterList.fromDate}" /></td>
												<td class="text-right"><fmt:formatNumber type="number"
														minFractionDigits="2" maxFractionDigits="2"
														value="${sewerageRatesMasterList.monthlyRate}" /></td>
												<td id="active" class="text-right"><c:out
														value="${sewerageRatesMasterList.active}" /></td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
