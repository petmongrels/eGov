...
public class SewerageRatesMasterService {
    ...
    @Transactional
    public SewerageRatesMaster sewerageRatesMasterRepository(final SewerageRatesMaster sewerageRatesMaster) {
        return sewerageRatesMasterRepository.save(sewerageRatesMaster);
    }

    @Transactional
    public void updateWaterRatesHeader(final SewerageRatesMaster sewerageRatesMaster) {
        sewerageRatesMasterRepository.save(sewerageRatesMaster);
    }

    public List<SewerageRatesMaster> findAll() {
        return sewerageRatesMasterRepository.findAll(new Sort(Sort.Direction.ASC, ""));
    }
